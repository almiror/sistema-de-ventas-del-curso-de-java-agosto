...
public class ReporteClientes {
    ...
    public void reporteClientes() {
        ...
        try {
            FileOutputStream archivo = new FileOutputStream("D:\\ventas/reporteclientes.pdf");
            ...
            PdfPCell descripcionProducto = new PdfPCell(new Phrase("Nombres", tituloTabla));
            ...
            try {
                ...
                while (rs.next()) {
                        PdfPCell nombrecliente = new PdfPCell(new Phrase(rs.getString("nombre"), fuenteDescripcion));
                        ...
                        PdfPCell datoCliente = new PdfPCell(new Phrase(rs.getString("apellido"), fuenteDescripcion));
                        ...
                        PdfPCell documentocliente = new PdfPCell(new Phrase(rs.getString("tipo_documento"), fuenteDescripcion));
                        ...
                        PdfPCell datoDocumentoCliente = new PdfPCell(new Phrase(rs.getString("numero_documento"), fuenteDescripcion));
            ...
            File abrirArchivo = new File("D:\\ventas/reporteclientes.pdf");
