...
public class ListaClientes extends javax.swing.JFrame {
    ...
    private void vistaClientes(String buscar){
        ...
        listaClientes.getColumnModel().getColumn(5).setMinWidth(0);
        listaClientes.getColumnModel().getColumn(5).setMaxWidth(0);
        listaClientes.getColumnModel().getColumn(5).setPreferredWidth(0);
    }
    ...
    private void listaClientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listaClientesMouseClicked
        ...
        Ventas.txtCliente.setText(listaClientes.getValueAt(fila, 1).toString() + " "+ listaClientes.getValueAt(fila, 2).toString());
        Ventas.idCliente.setText(listaClientes.getValueAt(fila, 0).toString());
        this.dispose();
